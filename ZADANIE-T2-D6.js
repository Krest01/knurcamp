...
*/
odpowiedź("getElementById");
uzasadnienie(`Jak sama nazwa mówi, szukami elementu z ID`);
...
*/
odpowiedź("B");
uzasadnienie(`a dlaczego by miało? po prostu go nie opóźnia ale to nie znaczy że cały kod jest szybszy`);
...
*/
odpowiedź("B,C,E");
uzasadnienie(`pozostawiam bez komentarza(był by długi)`);
...
*/
odpowiedź("value");
uzasadnienie(`Element input przechowuje wartość pod kluczem value`);
...
uzasadnienie(`nazwa jest prosta, maupia wręcz, interval czyli w równych odstępach z inglisz`);
...
*/
odpowiedź("B");
uzasadnienie(`Nie wiemy ile zajmie pozyskanie danych z serwera a nie chcemy żeby cała aplikacja stała w międzyczasie`);
...
*/
odpowiedź("A,B");
uzasadnienie(`jakikolwiek ruch przez internet powinien być asynchroniczny`);
...
uzasadnienie(`musimy powiedzieć kąkuterowi gdzie dokładnie chcemy mieć naszego papaja`);
...
uzasadnienie(`event listener nasłuchuje wydarzenia które ustalimy i wykonuje kod kiedy do niego dojdzie(wydarzenia)`);
